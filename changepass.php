...
<div id="id02" class=" p2">
       ...
       <form class="modal-content animate" action="includes/send.php" method="post">
           <div class="row">
               ...
               <div class="col-md-8">
                   ...
                   <label for="pass"><b>Change Password:</b></label><hr>
                       <input  type="password"value="" placeholder="Enter new password" name="pass" required>
       
                       <input  type="password"value="" placeholder="Retype password" name="pass2" required>
