...
<html lang="en">
  ...
  padding: 7px;
    ...
    <div class="pricing">
        <div class="row">
            <div class="col-9"> <span id="name">1. <img height="22px" src="img/a.png"> BEATS Solo 3 Wireless Headphones</span> </div>
