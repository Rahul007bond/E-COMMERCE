           ...
           <div class="row">
               <div class="container col-md-4 sideview">
                   ...
                   <div class="imgcontainer">
                       ...
                       <img src="verify.png" id="loginstyle">
                   </div>
               ...
               <div class="col-md-8">
                   ...
                   <div class="container" id="ggtp">
                       ...
                       $select="select email from customers where cusername='$user'";
                       $runs=mysqli_query($con,$select);
                        $row=mysqli_fetch_assoc($runs);
                        $mail=$row['email'];?>
<form method="post">
                       <label for="mail"><b>Email ID:</b></label><hr>
                       <input style="pointer-events: none; opacity:0.5;" id="mailto" type="email"value="<?php echo $mail?>" placeholder="Enter Email-id" name="mail" required>
    
                       
                       <button type="button" name="signup-submit" id="gotp" >Generate OTP</button>
                                      <input type="email"value="" placeholder="Enter here to update Email-id" id="mails" name="mail">
                       <button type="button"id="change" class="btn btn-md change" value="change Email">Change Email</button>   
                      <a href="includes/logout.inc.php" style="color:white;background-color: #f44336;" id="logout" class="btn btn-md " value="change Email">Logout</a>
        </form>
                   </div>
                   <div id="ootp">
                   <form method="post">
                   <label for="mail"><b>Email ID:</b></label><hr>
                       <input style="pointer-events: none; opacity:0.5;" type="email"value="<?php echo $mail?>" placeholder="Enter Email-id" name="mail" required>
           ...
           success: function(data) {
            ...
            var data = JSON.parse(data);
              if(data.statusCode==200){
                    window.location.replace("http://localhost/newp/index.php");				
                }
               else{
