...
<html lang="en">
    <head>
        ...
        <link href="lib/slick/slick-theme.css" rel="stylesheet"> <link href="css/new.css" rel="stylesheet">
    ...
    <!-- Bottom Bar End -->
        ...
        <div class="checkout">
            <div class="container-fluid"> 
                <div class="row ">
                <div class="col-lg-12 ">
                <form action="checkout.php" method="POST" class="checkout-inner">
                    ...
                    <div class="checkout-inner">
                        <div class="billing-address">
                            ...
                            <div style="pointer-events: none;" class="row mutedinfo">
                                ...
                                <div class="col-md-6">
                                    <label>First Name</label>
                                    <input class="form-control" type="text" value="<?php echo htmlspecialchars($first);?>"
                                        placeholder="First Name">
                                </div>
                                <div class="col-md-6">
                                    <label>Last Name</label>
                                    <input class="form-control" type="text" value="<?php echo htmlspecialchars($last);?>"
                                ...
                                <div class="col-md-6">
                                    <label>Mobile No</label>
                                    <input class="form-control" type="text" value="<?php echo htmlspecialchars($mobilno);?>"
                                        placeholder="Mobile No">
                                </div>
                                <div class="col-md-12">
                                    <label>Address</label>
                                    <input class="form-control" type="text" value="<?php echo htmlspecialchars($address);?>"
                                        placeholder="Address">
                                </div>
                                <div class="col-md-6">
                                    <label>Country</label>
                                    <select name="ctry" class="custom-select">
                                        <option value="<?php echo $countru;?>" selected><?php echo htmlspecialchars($countru);?></option>

                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <label>City</label>
                                    <input class="form-control" type="text" value="<?php echo htmlspecialchars($city);?>"
                                        placeholder="City">
                                </div>
                                <div class="col-md-6">
                                    <label>State</label>
                                    <input class="form-control" type="text" value="<?php echo htmlspecialchars($state);?>"
                                        placeholder="State">
                                </div>
                                <div class="col-md-6">
                                    <label>ZIP Code</label>
                                    <input class="form-control" type="text" value="<?php echo htmlspecialchars($zip);?>"
                    ...
                    <div class="col-lg-5">
                        <div class="checkout-inner">
                            <div class="checkout-summary">
                                ...
                                <p class="sub-total">Total<span>₹<?php echo $total;?></span></p>
                                <p class="ship-cost">Shipping Cost<span>₹<?php if($total>=600){
                                                $shipping=0;
                                                echo 0;}
                                                elseif($total==0){
                                                    $shipping=0;
                                ...
                                <h2>Grand Total<span>₹<?php $gtotal=$total+$shipping; echo number_format($gtotal)."<br>"; $_SESSION['gtotal']=$gtotal; ?></span></h2>
                            </div>
<?php if($gtotal>0){?>
    <?php If($rowsa){?>
                            <div class="checkout-payment">
                                ...
                                <div class="checkout-btn">
                                    <a href="razorpay/payf.php" class="btn btn-lg" name="placeorder">Pay with Razorpay</a>
                                </div>
                            </div>
                            <?php }?>
                            <?php }?>
