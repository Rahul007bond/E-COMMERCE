...
<label>
    ...
    <!-- Bottom Bar End -->
        ...
        <!-- Cart Start -->
        <form  action="cart.php" method="post" class="cart-page">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    while ($rowp=mysqli_fetch_array($runp)){
                                      ...
                                      <td>₹$subtotal2</td>
                                      <td>  <input type='checkbox'name='remove[]' value='$proid'></td>
                                  </tr>
                                      ";
                                ...
                                <div class="col-md-12">
                                    <div class="cart-summary">
                                        <div class="cart-content">
                                            <h1>Cart Summary</h1>
                                            <p>Sub Total<span><?php echo number_format($total)."<br>";?></span></p>
                                            <p>Shipping Cost<span><?php if($total>=600){
                                                $shipping=0;
                                                echo 0;}
                                                elseif($total==0){
                                                    $shipping=0;
                                            ...
                                            <h2>Grand Total <span> <?php $gtotal=$total+$shipping; echo number_format($gtotal)."<br>"; ?></span></h2>
                                        </div>
                                        <?php
                                        if($gtotal>0){?>
                                        <div class="cart-btn">
                                            ...
                                            <a href="checkout.php" class="btn btn-lg" >Checkout</a>
                                        </div>
                                        <?php
                                        }?>
                                    </div>
