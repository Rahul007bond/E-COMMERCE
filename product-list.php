...
if(isset($_GET['search'])||(isset($_GET['category']))){
    ...
    $cat=mysqli_real_escape_string($con,trim($_GET['category']));}
session_start();
                    ...
                    <div>
                        <form method="post">
                            <div class="container">
                                ...
                                <label for="mail"><b>Email ID: <sub>(only @gmail.com,@outlook.com,@yahoo.com)</sub></b>
                                </label>
                                ...
                                <label>
                                    <input type="checkbox" checked="checked" id="tmc" required name="remember"> Accept
        ...
        <div class="container-fluid">
            <div class="brand-slider">
                ...
                <div class="brand-item"><img style="filter: grayscale(100%);" src="img/jbl.png" width="150" height="80"
                        alt=""></div>
                <div class="brand-item"><img style="filter: grayscale(100%);" src="img/Quick-Heal-Logo.png" width="150"
                        height="80" alt="">
                </div>
