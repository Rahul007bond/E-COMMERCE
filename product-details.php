                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-5">
                                    <div class="product-content">
                                        ...
                                        <div class="price">
                                            <h4>Price:</h4>
                                            <p>₹<?php echo $price; ?><span>₹<?php echo $mrp; ?></span></p>
                                        </div>
                                        <div class="quantity">
                                            <h4>Quantity:</h4>
                                            <div class="qty">
                                        ...
                                        <div class="action">
                                            <a class="btn" href="#"><i class="fa fa-shopping-cart"></i><br>Add to Cart</a>
                                            <a class="btn" href="#"><i class="fa fa-shopping-bag"></i><br>Buy Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="reviews" class="container tab-pane fade">
                                        ...
                                        <div class='reviewer'>usernamer - <span>dates</span></div>
				<div class='ratting'>
                <i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i>
                </div>
				<p>
					qwqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq
				</p>
                                        </div>
                                     <div class="reviews-submit">
                                        <form action="" method="POST" >
                                            ...
                                            <div class="row form">
                                                ...
                                                <div class="col-sm-12">
                                                    <button type="button" name="submitr">Submit</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
