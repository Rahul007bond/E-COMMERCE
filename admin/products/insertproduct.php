		...
		<div class="panel panel-default">
			...
			<div class="panel-body"  style="background-color:#2874; border-radius: 25px;padding:10px;">
				<form class="form-horizontal"method="post" action="" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label class=" control-label" >
							Product Color(HEX is also allowed)
						</label>
...
$insrt="insert into uproducts(color,product_catid,specification,date,product_title,productimg1,productimg2,productimg3,productimg4,productimg5,productprice,productdesc,productkeyword,mrp,available) values(''$color',$product_cat','$specs',NOW(),'$producttitle','$productimg1','$productimg2','$productimg3','$productimg4','$productimg5','$productprice','$productdesc','$productkey','$mrp','$qty')
";
