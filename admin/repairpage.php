...
<div class="wrapper">
  ...
  <div class="main_container">
      <div class="sidebar ">
          <div class="sidebar__inner">
            ...
            <ul>
              ...
              <li>
                <a href="repairpage.php" class="active">
      ...
      <div class="container">
     <a class="btn btn-lg" href="repair.php"> <div id="dashimg" >
                                    <img class="dashimg" src="../repair.png">
                                </div><hr>
         Insert Product
     </a>
 
    <a class="btn btn-lg " href="Viewproducts.php"> <div id="dashimg" >
                                    <img class="dashimg" src="../repair.png">
                                </div><hr>
        View all (<?php counttotal();?> )
    </a>
      </div>
  </div>
