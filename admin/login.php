       ...
       <form class="modal-content animate" action="includes/signup.inc.php" method="post">
           <div class="row">
               <div class="container col-md-4 sideview">
                   ...
                   <img src="../adminlogin.png" id="loginstyle">
                   </div>
...
<form method="post">
                       ...
                       <input  id="mailts" type="email" placeholder="Enter Email-id" >
    
                       
                       <button type="button" name="signup-submit" id="fgotps" >Generate OTP</button>
                   ...
                   <form method="post">
                   <label for="mail"><b>Email ID:</b></label><hr>
                       <input style="pointer-events: none; opacity:0.5;" type="email" value="r*************007bond@gmail.com" placeholder="Enter Email-id" name="mail" required>
   ...
   <script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
    ...
    $('.loader').hide();
    $("body").delegate("#fgotps","click",function(event){
        var emailss=$("#mailts").val();
        $("#fgotps").attr("disabled", true);
       $('.loader').show();
