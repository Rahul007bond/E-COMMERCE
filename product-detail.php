...
if (isset($_GET['pro_id'])) {
   $prodi=$_GET['pro_id'];
   $getpro="select * from products where id='$prodi'";
                           ...
                           <div class="row align-items-center">
                               ...
                               <div class="col-md-5">
                                   ...
                                   <div class="product-content">
                                       ...
                                       <span style="padding:5px;font-size:17px;color:white; background-color:#388e3c; border-radius:5px;" id="#spans"><?php echo round($rsd,1);?> <i class="fas fa-star" style="color:white;"></i></span>
                                       <hr>
                                       <div class="price">
                                           <h4>Price:</h4>
                                        <br>
                                       ...
                                       <div class="quantity">
                                           ...
                                           <div class="qty">
                                               ...
                                               <input type="text" id="qtyq" value="1">
                                       ...
                                       <div class="action">
                                           <button class="btn addtocart" type="button" ><i class="fa fa-shopping-cart"></i><br>Add to Cart</button>
